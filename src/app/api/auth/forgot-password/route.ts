...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Endpoint: /api/auth/forgot-password');
    ...
    const backendEndpoint = `${API_BASE_URL_USER}/user/forgotpasswd`;
    ...
    if (!responseText.trim()) {
      console.error('\n❌ EMPTY RESPONSE');
      console.log('==================================================\n');
      throw new Error('Empty response from forgot password API');
    }
